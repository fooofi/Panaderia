...
@section('title', 'Recuperar Contraseña del Portal')
@section('preheader', 'Recupera tu contraseña de Portal MundoTES')
  ...
  <tr>
    <td class="content-cell">
      <div class="f-fallback">
        <h1>¡Hola, {{$name}}!</h1>
        <p>Nos dimos cuenta  que solicitaste recuperar tu contraseña para tu cuenta del Portal de MundoTES.</p>
        <p>Utiliza el botón a continuación para reestablecerla.  Esta contraseña será válida por los siguientes 60 minutos.</p>
        <!-- Action -->
